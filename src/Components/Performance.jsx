                    ...
                    <div id="slide1" className="carousel-item relative w-full">
                        <div className="flex items-center gap-12 container mx-auto pb-86 pt-35">
                            ...
                            <div className="text-right">
                                <div>
                                    ...
                                    <strong className="block text-[24px] font-normal text-black ">
                                        Shamol Cina
                                    </strong>
                                    <small className=" text-[rgba(0,0,0,0.50)] text-[20px] mb-4 ">
                       ...
                       '>01/  <span className='text-gray-500'>03</span></h6>
                                    ...
                                    <div className=" mr-6  flex gap-4">
                                        <a href="#slide4" className="btn btn-circle hover:bg-orange-500"> <FaLongArrowAltLeft className="w-5 h-5 text-black" /> </a>
